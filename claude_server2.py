...
# nextflow (optimize workflow) => workflow manager (python version snakemake)
# implications for rfdiffusion, alphafold, ...
...
def initialize_folders(ctx: Context, base_path: Optional[str] = None) -> str:
    ...
    try:
        ...
        print("protos base path set to:", protos_ctx.base_path)
